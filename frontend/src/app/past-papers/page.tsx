            ...
            <div className="max-w-7xl mx-auto flex justify-between items-center">
                ...
                <div className="flex items-center gap-4">
                    ...
                    {user && profile ? (
                        ...
                        <Link href="/login" className="flex items-center gap-2 px-4 py-2 bg-brand-burgundy text-white rounded-lg hover:bg-brand-burgundy/90 font-semibold">
                            <LogIn size={18} />
                            Login
                        </Link>
                    )}
            ...
            <div className="p-8 max-w-7xl mx-auto">
                ...
                {!user && (
                    <div className="bg-gradient-to-r from-brand-burgundy to-brand-pink text-white rounded-xl p-6 mb-6 flex items-center justify-between">
                        ...
                        <Link href="/signup" className="px-6 py-3 bg-white text-brand-burgundy font-bold rounded-lg hover:bg-gray-100 transition-colors whitespace-nowrap">
                            Sign Up Free
                        </Link>
                    </div>
                )}
